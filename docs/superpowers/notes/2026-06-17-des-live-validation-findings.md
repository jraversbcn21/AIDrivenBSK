...
**The suite tests DES's TRUE DESKTOP layout. Suite is now 25 tests (was 15 through 2026-08-06 morning) — coverage expansion §30 promoted 10 more Builder drafts same day; latest full run 23/25 passed, 2 flaky (both recovered on retry #1, neither in the new specs), 0 failed.**
