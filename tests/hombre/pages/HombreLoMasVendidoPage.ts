// Promoted from a Builder-generated draft (flow flow_c7db424e3c9f, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class HombreLoMasVendidoPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/hombre/ropa/lo-mas-vendido-n3663.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Lo más vendido para hombre/.test(await this.page.title())) return false;
