// Promoted from a Builder-generated draft (flow flow_6eba98046c4e, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class CamisetaMangaLargaCuelloRedondoPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/camiseta-manga-larga-cuello-redondo-c0p234325056.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Camiseta manga larga cuello redondo/.test(await this.page.title())) return false;
