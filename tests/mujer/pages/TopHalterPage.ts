// Promoted from a Builder-generated draft (flow flow_8cafc56f4bbc, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class TopHalterPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/top-halter-c0p234325003.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Top halter/.test(await this.page.title())) return false;
