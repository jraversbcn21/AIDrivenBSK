// Promoted from a Builder-generated draft (flow flow_571ec8059931, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class ChaquetaCapuchaCremalleraFelpaPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/chaqueta-capucha-cremallera-felpa-c0p233573615.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Chaqueta capucha cremallera felpa/.test(await this.page.title())) return false;
