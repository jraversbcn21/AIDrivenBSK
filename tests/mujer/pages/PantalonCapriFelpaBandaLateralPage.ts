// Promoted from a Builder-generated draft (flow flow_ad9480462ea2, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class PantalonCapriFelpaBandaLateralPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/pantal%c3%b3n-capri-felpa-banda-lateral-c0p233573672.html');
  }
   ...
   *    unique on desktop 2026-08-04, `data-qa-anchor="addToCartBtn"`, findings §12).
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Pantalón capri felpa banda lateral/.test(await this.page.title())) return false;
