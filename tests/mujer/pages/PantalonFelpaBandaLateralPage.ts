// Promoted from a Builder-generated draft (flow flow_02bc901d3ab6, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class PantalonFelpaBandaLateralPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/pantal%c3%b3n-felpa-banda-lateral-c0p233573642.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Pantalón felpa banda lateral/.test(await this.page.title())) return false;
