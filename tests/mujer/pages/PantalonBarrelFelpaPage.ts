// Promoted from a Builder-generated draft (flow flow_3897e29f7d4d, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class PantalonBarrelFelpaPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/pantal%c3%b3n-barrel-felpa-c0p234325030.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Pantalón barrel felpa/.test(await this.page.title())) return false;
