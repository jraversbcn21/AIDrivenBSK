// Promoted from a Builder-generated draft (flow flow_f03ba360f315, map generated
// 2026-07-30). No longer auto-generated — maintained by hand from here on.
import { BasePage } from '../../../src/pages/BasePage';
import { locate } from '../../../src/support/locators';

export class SudaderaCapuchaCremalleraFelpaPage extends BasePage {
  /**
  ...
  async open(): Promise<void> {
    ...
    await this.goto('/es/sudadera-capucha-cremallera-felpa-c0p234325014.html');
  }
  ...
  async isLoaded(): Promise<boolean> {
    if (!/^Sudadera capucha cremallera felpa/.test(await this.page.title())) return false;
