...
**Current state (2026-08-06):** Suite **15 tests, live-green on TRUE desktop, 15/15 zero retries**. Platform in **use-and-maintain, no open queue item**. Two things landed today, both worth knowing before touching anything:
